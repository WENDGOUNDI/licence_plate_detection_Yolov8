...
def main():
    ...
    while True:
        ...
        #detections = detections[detections.class_id == 2] # filetr all classes and only detect cars. Cars label_id==2
        #detections = detections[detections.class_id != 0] # to discard human label
        labels = [
